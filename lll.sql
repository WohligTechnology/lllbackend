...
--
-- Table structure for table `lll_article`
--

CREATE TABLE IF NOT EXISTS `lll_article` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `lll_category`
--

CREATE TABLE IF NOT EXISTS `lll_category` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `lll_enquiry`
--

CREATE TABLE IF NOT EXISTS `lll_enquiry` (
  `id` int(11) NOT NULL,
...
--
-- Table structure for table `lll_recommendarticle`
--

CREATE TABLE IF NOT EXISTS `lll_recommendarticle` (
  `id` int(11) NOT NULL,
  `article` int(11) NOT NULL,
  `recommendarticle` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(1, 'Users', '', '', 'site/viewusers', 1, 0, 1, 2, 'icon-user'),
...
--
-- Indexes for table `lll_article`
--
ALTER TABLE `lll_article`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `lll_category`
--
ALTER TABLE `lll_category`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `lll_enquiry`
--
ALTER TABLE `lll_enquiry`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `lll_recommendarticle`
--
ALTER TABLE `lll_recommendarticle`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `lll_recommendarticle`
--
ALTER TABLE `lll_recommendarticle`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
